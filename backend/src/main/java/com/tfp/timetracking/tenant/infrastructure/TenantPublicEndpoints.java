 ...
 * defecto (RF-TEN-010, ADR-0010) y con el flag apagado los controladores
 * responden 403. Las rutas se declaran igualmente para que la respuesta la
 * decida la regla de negocio y no un 401 generico de la cadena de filtros.
 */
@Component
public class TenantPublicEndpoints implements PublicEndpointsContributor {
    ...
    public List<PublicEndpoint> publicEndpoints() {
        return List.of(
                // Alta directa heredada del MVP (ADR-0013): sigue creando un
