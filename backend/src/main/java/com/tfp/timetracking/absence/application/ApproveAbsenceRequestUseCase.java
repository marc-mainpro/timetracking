...
@Service
public class ApproveAbsenceRequestUseCase {
    ...
    public ApproveAbsenceRequestUseCase(
    ...
    @Transactional
    public AbsenceRequest approve(ResolveAbsenceCommand command) {
        ...
        request.approve(tenantContext.currentUserId(), command.resolutionComment(), clock.now(), idGenerator);
