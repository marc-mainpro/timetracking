...
class StartBreakUseCaseTest {

    @Test
    void startsBreakOnActiveWorkdayAndPublishesEvent() {
        ...
        Clock clock = () -> Instant.parse("2026-01-15T10:00:00Z");
        IdGenerator idGenerator = () -> UUID.randomUUID();
        StartBreakUseCase useCase = new StartBreakUseCase(repository, tenantContext, clock, idGenerator, publisher);
